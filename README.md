...
```
Brahmi/
├── Brahmi_code.ipynb      # Main training notebook
├── Brahmi-Dataset.zip     # Dataset (link/placeholder)
└── README.md              # This file
```
...
```
@software{brahmi_recognition,
  author = {Bibek478},
  title = {Brahmi Script Character Recognition},
  year = {2024},
  url = {https://github.com/Bibek478/Brahmi}
}
```
...
- [Brahmi Script](https://en.wikipedia.org/wiki/Brahmi_script) - Wikipedia article on Brahmi script
- [Transfer Learning Guide](https://www.tensorflow.org/tutorials/images/transfer_learning) - TensorFlow transfer learning tutorial
